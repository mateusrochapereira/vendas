...
import com.projeto.vendas.exception.RegraNeogicoException;
...
public class PedidoServiceImpl implements PedidoService {
    ...
    public Pedido salvar(PedidoDTO dto) {
        ...
        Cliente cliente = clientesRepository
                .findById(idCliente)
                .orElseThrow( () -> new RegraNeogicoException("Codigo de cliente inválido"));
    ...
    private List<ItemPedido> converterItems(Pedido pedido, List<ItemPedidoDTO> items){
        if(items.isEmpty()){
            throw  new RegraNeogicoException("Não é possivel realizar um pedido sem items.");
        }
        ...
        return items
                ...
                .map( dto ->{
                    ...
                    Produto produto = produtosRepository
                            .findById(idProduto)
                            .orElseThrow(
                                    () -> new RegraNeogicoException("Código de Produto inválido:"+ idProduto
